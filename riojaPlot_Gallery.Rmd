...
- Flexible - with a number of different plotting styles and ability to add a secondary y-axis, cumulative summary plot, zones and lithology.  See section .intro-high[[**`r G2`**](#14)]. 

- Build complex diagrams showing multiple datasets or proxies measured at different depth intervals, each with their own style.  See section .intro-high[[**`r G3`**](#28)]. 

- Customisable - .intro-code[**riojaPlot**] allows the use of user-defined plotting functions to customise plots and add additional features such as gam smoothes, breakpoints, or customised labels.  See section .intro-high[[**`r G4`**](#33)].
